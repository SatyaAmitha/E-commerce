          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:block">
              <input
                ...
                className="px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent w-64 bg-white text-gray-900"
              />
            </div>
